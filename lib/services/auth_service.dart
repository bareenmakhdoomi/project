...
//create a firebase user
  Future<bool> createUser(
    ...
    print("jimmy");
    if (res.user != null) {
      print(name.toString() + ' ' + ' ' + email.toString() + ' ' + country.toString() + " --------------------------");
  ...
  Future<void> saveUserToFirestore(String name, User user, String email, String country) async {
    CollectionReference users = FirebaseFirestore.instance.collection('users');
    print("vcnsjkdnjkvcbnizshbndv ns");
